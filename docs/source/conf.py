...
.. |link_docs_ide| raw:: html
    ...
    <a href="https://docs.arduino.cc/software/ide-v2/tutorials/getting-started-ide-v2/" target="_blank">Pour commencer avec Arduino IDE 2</a>
...
.. |link_arduino_docs| raw:: html
    ...
    <a href="https://docs.arduino.cc/" target="_blank">Documentation officielle Arduino</a>

.. |link_download_arduino| raw:: html

    <a href="https://www.arduino.cc/en/software#future-version-of-the-arduino-ide" target="_blank">Page du logiciel Arduino</a>
...
.. |link_arduino_reference| raw:: html
    ...
    <a href="https://www.arduino.cc/reference/en/" target="_blank">Référence du langage</a>
