...
Vidéo 12 : Comment utiliser switch-case dans les programmes Arduino
=================================================================================================

Cette leçon explique comment les instructions switch-case sont utilisées dans Arduino.

* **Structure switch :** Explique la syntaxe des instructions switch-case.
* **Correspondance des cas :** Montre comment faire correspondre des valeurs aux différents cas.
* **Cas par défaut :** Explique comment les valeurs non correspondantes sont traitées.
* **Clarté du code :** Montre comment switch-case simplifie la logique.

.. raw:: html

    <iframe width="100%" 
        style="aspect-ratio: 16/9; max-width: 100%;"
        src="https://www.youtube.com/embed/EDtnQj18g-M" 
