...
Vidéo 15 : Comment utiliser les opérateurs composés en programmation Arduino
=============================================================================================

Cette leçon présente les opérateurs composés utilisés dans le code Arduino.

* **Opérateurs composés :** Explique des opérateurs tels que **+=**, **-=**, ***=** et **/=**.
* **Mise à jour des valeurs :** Montre comment mettre à jour des variables à l’aide d’opérateurs composés.
* **Simplification du code :** Montre comment les opérateurs composés réduisent la répétition.
* **Exemples d’utilisation :** Montre des exemples d’opérateurs composés dans les sketches.

.. raw:: html

    <iframe width="100%" 
        style="aspect-ratio: 16/9; max-width: 100%;"
        src="https://www.youtube.com/embed/ZguDk_JT-RQ" 
