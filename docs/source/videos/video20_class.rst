...
Video 20: Arduino プログラムにおけるクラスとオブジェクトの仕組み
============================================================================

このレッスンでは、Arduino における基本的なオブジェクト指向プログラミングの概念を紹介します。

* **クラス:** クラスがデータと動作をどのように定義するかを説明します。
* **オブジェクト:** クラスからオブジェクトを作成する方法を実演します。
* **メンバ変数:** クラスのプロパティを紹介します。
* **メンバ関数:** クラスメソッドの使い方を示します。
