...
Video 27: アクティブブザーとパッシブブザーの使い方
==========================================================================================

このレッスンでは、アクティブブザーとパッシブブザーの違いについて紹介します。

* **ブザーの種類:** アクティブブザーとパッシブブザーの違いを説明します。
* **配線方法:** ブザーを Arduino に接続する方法を実演します。
* **音の生成:** パッシブブザーで音を生成する方法を示します。
* **音の制御:** ブザーの出力を制御する方法を実演します。
