...
Vidéo 4 : Comment contrôler les LED
======================================================

Cette leçon montre comment contrôler des LED à l’aide des broches de sortie numériques d’Arduino.

* **Notions de base sur les LED :** Explique la polarité des LED et la nécessité des résistances de limitation de courant.
* **Câblage des LED :** Montre comment connecter une LED à une broche Arduino.
* **Sortie numérique :** Montre comment contrôler l’état des LED à l’aide du code.
* **Sketches simples :** Utilise des sketches de base pour allumer et éteindre les LED.
